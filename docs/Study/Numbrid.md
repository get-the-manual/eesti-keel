...
Эта форма отвечает на вопрос **«Который по счету?»**.  
Мы используем её для дат, этажей, мест в очереди.
...
Это форма **Alaleütlev** (падеж направления «на что-то»).  
Она образуется по формуле: **Колонка 2 (Omastav) + суффикс -le**.
...
От одного числа растут две разные ветки: **количественная** (сколько?) и **порядковая** (который?).
