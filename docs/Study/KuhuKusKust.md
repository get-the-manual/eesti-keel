...
В эстонском языке логика падежей места (как «внутренних», так и «внешних») обычно следует правилу: **Kuhu? (Куда?), Kus? (Где?), Kust? (Откуда?)**
...
- вопрос **KUHU? (Куда?)**   для глаголов: unustasin (забыл)  
- вопрос **KUST? (Откуда?)**  применяется для глаголов: tulen (пришел), leidma (находить), ostma (покупать), saama (получить), laenama (одолжить) 
...
### Внутрь (... в...) (Sisseütlev kääne): **-s**, **-sse**, **-st**

| **MIS? MILLE? <br>(Что? Чего?)**<br> 1,2 vorm | KUHU? (КУДА?) <br>sõidan, lähen, unustasin<br>**-sse** | KUS? (ГДЕ?) <br> olen, käin, kaotasin<br> **-s** | KUST? ОТКУДА?<br> tulen, ostan, leidsin, sain, laenasin <br> **-st** |
| --------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------ | -------------------------------------------------------------------- |
| amet, -i (должность, ведомство)               | ametisse                                               | ametis                                           | ametist                                                              |
| haigla (больница)                             | haiglasse                                              | haiglas                                          | haiglast                                                             |
...
Примеры:  
Ma lähen linnavalitsusse.  
Sõidame kodust parklasse.  
Meie auto seisab kesklinna parklas.

### На поверхность (... на ...) (Alaleütlev) **-l**e, **-l**, **-lt**

| **MIS? MILLE? <br>(Что? Чего?)**<br> 1,2 vorm | KUHU? (КУДА?) <br>sõidan, lähen, unustasin<br>**-le** | KUS? (ГДЕ?) <br> olen, käin, kaotasin<br> **-l** | KUST? ОТКУДА?<br> tulen, ostan, leidsin, sain, laenasin<br> **-lt** |
| --------------------------------------------- | ----------------------------------------------------- | ------------------------------------------------ | ------------------------------------------------------------------- |
| kontsert, kontserdi                           | kontserdile                                           | kontserdil                                       | kontserdilt                                                         |
| korrus, korruse (этаж)                        | korrusele                                             | korrusel                                         | korruselt                                                           |
...
| parem, parema (право)                         | paremale                                              | paremal                                          | paremalt                                                            |
...
Примеры:  
Ma lähen Raekoja platsile.   
Ma tulen kirikust jõulukontserdilt.  

### Краткая форма, **Lühike vorm**

| **MIS? MILLE? <br>(Что? Чего?)**<br> 1,2 vorm | KUHU? (КУДА?) <br>**sõidan, lähen, unustasin<br>-** | KUS? (ГДЕ?) <br> **olen, käin, kaotasin<br> -s** | KUST? ОТКУДА?<br> **tulen, ostan, leidsin, sain, laenasin<br> -st** |
| --------------------------------------------- | ------------------------------------------------------- | ---------------------------------------------------- | ----------------------------------------------------------------------- |
...
Примеры:  
Ta töötab apteegis.  
Ma unustasin oma rahakoti raudteejaama.  
Jõululaupäeva õhtul sõitsime kirikust koju.  
Ma tulen raamatukogust.  
Ma käin tihti laupäeviti raamatukogu.  
Lähme järgmine kord koos raamatukokku.
