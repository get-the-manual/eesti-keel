...
Партнером будет такой же экзаменуемый и незнакомый Вам человек, поэтому бы неплохо познакомиться со своим будущим партнером заранее и попробовать поговорить, потренироваться, задавая друг другу вопросы.  
Это позволит узнать человека поближе, привыкнуть к его голосу и произношению.

Ниже приведен список простых вопросов, которые можно задавать друг другу.

Также можно нажать на ссылку `Сгенерировать новые списки` и тогда будет сформировано два списка с вопросами для двух человек и QR-код этой страницы. Код может считать телефоном ваш партнер и открыть в телефоне эту же страницу со списками вопросов.  
Далее вы сможете задавать вопросы друг другу.
